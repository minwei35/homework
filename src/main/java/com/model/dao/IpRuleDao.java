...
public class IpRuleDao {
    ...
    static {
        ...
        ipToStation.put(1001,new IpRule(1001,"192.168.1.1",new StationHtml(1001,"station 1","1.html")));
        ipToStation.put(1002,new IpRule(1002,"192.168.2.1",new StationHtml(1002,"station 2","2.html")));
        ipToStation.put(1003,new IpRule(1003,"192.168.3.1",new StationHtml(1003,"station 3","3.html")));
        ipToStation.put(1004,new IpRule(1004,"192.168.4.1",new StationHtml(1004,"station 4","4.html")));
    }
